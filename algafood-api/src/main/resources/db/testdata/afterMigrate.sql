...
values (1, 'Restaurante fescorer', 10.00, 1, utc_timestamp, utc_timestamp, true, true);
insert into restaurante(id, nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao, ativo, aberto)
values (2, 'Restaurante Narcopólio', 12.00, 2, utc_timestamp, utc_timestamp, true, true);

insert into restaurante(id, nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao, ativo, aberto,
endereco_cidade_id, endereco_cep, endereco_logradouro, endereco_numero, endereco_bairro)
values (3, 'Thai Gourmet', 10, 1, utc_timestamp, utc_timestamp, true, true, 1, '38400-999', 'Rua João Pinheiro', '1000',
'Centro');
insert into restaurante(id, nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao, ativo, aberto)
values (4, 'Thai Delivery', 9.50, 1, utc_timestamp, utc_timestamp, true, true);
insert into restaurante(id, nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao, ativo, aberto)
values (5, 'Tuk Tuk Comida Indiana', 15, 2, utc_timestamp, utc_timestamp, true, true);
insert into restaurante(id, nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao, ativo, aberto)
values (6, 'Java Steakhouse', 12, 3, utc_timestamp, utc_timestamp, true, true);
insert into restaurante(id, nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao, ativo, aberto)
values (7, 'Lanchonete do Tio Sam', 11, 4, utc_timestamp, utc_timestamp, true, true);
insert into restaurante(id, nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao, ativo, aberto)
values (8, 'Bar da Maria', 6, 4, utc_timestamp, utc_timestamp, true, true);
...
insert into produto(nome, descricao, preco, ativo, restaurante_id)
values ('T-Bone',
'Corte muito saboroso, com um osso em formato de T, sendo de um lado o contrafilé e do outro o filé mignon', 89, 1, 4);
...
values (1, 'João da Silva', 'joao.ger@algafood.com', '$2a$12$pY8XKi.kW8lnpaQtm9xA9upitDA0eDl5ON0V7vBWGN4rnWeW3ZomO', utc_timestamp),
(2, 'Maria Joaquina', 'maria.vnd@algafood.com', '$2a$12$pY8XKi.kW8lnpaQtm9xA9upitDA0eDl5ON0V7vBWGN4rnWeW3ZomO', utc_timestamp),
(3, 'José Souza', 'jose.aux@algafood.com', '$2a$12$pY8XKi.kW8lnpaQtm9xA9upitDA0eDl5ON0V7vBWGN4rnWeW3ZomO', utc_timestamp),
(4, 'Sebastião Martins', 'sebastiao.cad@algafood.com', '$2a$12$pY8XKi.kW8lnpaQtm9xA9upitDA0eDl5ON0V7vBWGN4rnWeW3ZomO', utc_timestamp),
(5, 'Marcus Vinicius', 'marcusvini370@gmail.com', '$2a$12$pY8XKi.kW8lnpaQtm9xA9upitDA0eDl5ON0V7vBWGN4rnWeW3ZomO', utc_timestamp),
...
insert into usuario(id, nome, email, senha, data_cadastro)
values (7, 'Manoel Lima', 'manoel.loja@gmail.com', '123', utc_timestamp);
...
values (1, '33788b00-4055-48be-9c74-3d5975cf3842', 1, 1, 1, 1, '38400-000', 'Rua Floriano Peixoto', '500', 'Apto 801',
'Brasil',
