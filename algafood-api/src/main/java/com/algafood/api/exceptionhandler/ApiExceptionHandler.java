...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleBindException(BindException ex, HttpHeaders headers, HttpStatus status,
        ...
        return handleValidantionInternal(ex, headers, status, request, ex.getBindingResult());
    }
    ...
    private ResponseEntity<Object> handleValidantionInternal(Exception ex, HttpHeaders headers, HttpStatus status,
