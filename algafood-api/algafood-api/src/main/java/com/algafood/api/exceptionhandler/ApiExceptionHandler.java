...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
	...
	protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
		...
		BindingResult bildBindingResult = ex.getBindingResult(); // acesso a quais fields ou propriedades foram violadas
																	// as msg etc
	...
	public ResponseEntity<?> handleEntidadeNaoEcnotrado(EntidadeNaoEncontradaExcpetion ex, WebRequest request) {
	...
	public ResponseEntity<?> handleEntidadeEmuso(EntidadeEmusoExcpetion ex, WebRequest request) {
