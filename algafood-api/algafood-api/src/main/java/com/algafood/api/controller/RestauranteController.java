...
@CrossOrigin(origins = "*") //libera todos endpoint da classe/ serve para liberar apenas endpoins espec[ificos tbm
@RestController
...
public class RestauranteController {
	...
	@GetMapping@JsonView(RestauranteView.resumo.class)
